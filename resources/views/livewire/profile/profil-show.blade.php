                ...
                <div class="col-lg-10 col-xl-8">
                    ...
                    <div class="card shadow-sm border-light rounded-lg">
                        <div class="card-header text-center">
                            <h3 class="mb-0">{{ $userData->name ?? '-' }}</h3>
                        </div>
                        <div class="card-body">

                            <div class="row g-3 justify-content-center">

                                <!-- FOTO PROFIL SELALU DI ATAS -->
                                    ...
                                    <div class="row g-3">
                                        ...
                                        @if($role == 'guru' && isset($userData->kd_guru))
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control" value="{{ $userData->kd_guru }}" readonly>
                                            </div>
                                        @endif
                                        ...
                                        @if($role == 'bendahara' && isset($userData->kd_bendahara))
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control" value="{{ $userData->kd_bendahara }}" readonly>
                                            </div>
                                        @endif
                                        ...
                                        @if($role == 'karyawan' && isset($userData->kd_tu))
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control" value="{{ $userData->kd_tu }}" readonly>
                                            </div>
                                        @endif
                                        ...
                                        @if(($role == 'siswa' || $role == 'alumni') && isset($userData->nis))
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control" value="{{ $userData->nis }}" readonly>
                                            </div>
                                        @endif
                                        ...
                                        @if(isset($userData->no_hp))
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control" value="{{ $userData->no_hp }}" readonly>
                                            </div>
                                        @endif
                                        ...
                                        @if($role == 'siswa' || $role == 'alumni')
                                            ...
                                            @if(isset($userData->tempat_lahir))
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ $userData->tempat_lahir }}" readonly>
                                                </div>
                                            ...
                                            @if(isset($userData->alamat))
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="form-control" rows="2" readonly>{{ $userData->alamat }}</textarea>
                                                </div>
                                            @endif
                                        @endif
