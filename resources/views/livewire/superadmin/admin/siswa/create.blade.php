    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-4 py-2">
            <div class="form-group local-forms">
                ...
                <input wire:model="name" class="form-control" type="text" placeholder="Masukkan nama lengkap" />
        ...
        <div class="col-12 col-sm-4 py-2">
            <div class="form-group local-forms">
                ...
                <input wire:model="tempat_lahir" class="form-control" type="text" placeholder="Masukkan tempat lahir" />
        ...
        <div class="col-12 col-sm-4 py-2">
            <div class="form-group local-forms">
                ...
                <input wire:model="no_hp" class="form-control" type="text" placeholder="Masukkan nomor HP" />
        ...
        <div class="col-12 col-sm-4 py-2">
            <div class="form-group local-forms">
                ...
                <input wire:model="email" class="form-control" type="email" placeholder="Masukkan email" />
        ...
        <div class="col-12 col-sm-4 py-2">
            <div class="form-group local-forms">
                ...
                @if ($ijazah_terakhir)
                    <small class="text-success">File dipilih: {{ $ijazah_terakhir->getClientOriginalName() }}</small>
                @endif
            </div>
        </div>
        ...
        <div class="col-12 col-sm-8 py-2">
            <div class="form-group local-forms">
                ...
                <textarea wire:model="alamat" class="form-control" placeholder="Masukkan alamat"></textarea>
