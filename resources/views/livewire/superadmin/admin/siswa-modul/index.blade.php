                                    ...
                                    <tbody class="table-group-divider">
                                        @forelse($siswas as $index => $siswa)
                                            <tr>
                                                ...
                                                <td>{{ $siswa->name }}</td>
                                                <td class="text-center">{{ $siswa->jumlahPelajaran }}</td>
                                                <td class="text-center">
                                                    @php
                                                        $isAktif = $siswa->rombels->where('tahun_ajaran_id', $tahunAjaranAktif->id ?? 0)->isNotEmpty();
                                                    @endphp
                                                    @if($isAktif)
                                                        <span class="badge {{ $siswa->status ? 'bg-success' : 'bg-danger' }}">
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('superadmin.admin.siswa-modul.show', $siswa->id) }}"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center text-muted">Belum ada siswa tersedia.
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
