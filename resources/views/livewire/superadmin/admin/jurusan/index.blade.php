<div>
    ...
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0"><i class="bi bi-building"></i>{{$title}}</h3>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-sm table-bordered">
                                    ...
                                    <tbody class="table-group-divider">
                                        ...
                                        <tr>
                                            <td class="text-center">{{ $jurusans->firstItem() + $index }}</td>
                                            <td>{{ $item->kode }}</td>
                                            <td>{{ $item->nama }}</td>
    ...
    @include('livewire.superadmin.admin.jurusan.create')
    @script
    <script>
    ...
    @endscript
    @include('livewire.superadmin.admin.jurusan.edit')
    @script
    <script>
