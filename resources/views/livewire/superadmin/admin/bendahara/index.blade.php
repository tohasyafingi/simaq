<div>
                                    ...
                                    <tbody class="table-group-divider">
                                        @forelse($bendaharas as $index => $bendahara)
                                            <tr>
                                                ...
                                                <td>{{ $bendahara->kd_bendahara }}</td>
                                                <td>{{ $bendahara->name }}</td>
                                                <td>{{ $bendahara->no_hp }}</td>
    ...
    @endscript
    @include('livewire.superadmin.admin.bendahara.edit')
    @script
    <script>
    ...
    @endscript
    @include('livewire.superadmin.admin.bendahara.delete')
    @script
    <script>
