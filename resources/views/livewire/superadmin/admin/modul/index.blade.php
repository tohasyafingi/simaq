<div>
    ...
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0"><i class="fas fa-book"></i> Data {{$title}}</h3>
                </div>
                <div class="col-sm-6">
    ...
    @include('livewire.superadmin.admin.modul.create')
    @script
    <script>
    ...
    @include('livewire.superadmin.admin.modul.edit')
    @script
    <script>
    ...
    @include('livewire.superadmin.admin.modul.delete')
    @script
    <script>
