<div class="news-detail-page py-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <h1 class="fw-bold mb-3 text-center" data-aos="fade-up" data-aos-duration="800">{{ $berita->judul }}</h1>
    ...
    <script>
        if (!window.SHARE_DATA) {
            window.SHARE_DATA = {
                title: "{{ addslashes($fullTitle ?? $berita->judul) }}",
                text: "{{ addslashes($description ?? $berita->judul) }}",
