<div>
    ...
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0"><i class="fas fa-address-book"></i>{{$title}}</h3>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-sm table-bordered">
                                    ...
                                    <tbody class="table-group-divider">
                                        ...
                                        <tr>
                                            <td class="text-center">{{ $kontaks->firstItem() + $index }}</td>
                                            <td>{{ $item->alamat }}</td>
                                            <td>{{ $item->telepon }}</td>
                                            <td>{{ $item->email }}</td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button wire:click="confirmDelete({{ $item->id }})" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal">
    ...
    @include('livewire.superadmin.admin.kontak.create')
    @script
    <script>
    ...
    @endscript
    @include('livewire.superadmin.admin.kontak.edit')
    @script
    <script>
    ...
    @endscript
    @include('livewire.superadmin.admin.kontak.delete')
    @script
    <script>
