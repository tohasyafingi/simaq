<div>
    ...
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0"><i class="bi bi-door-closed"></i>{{$title}}</h3>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-sm table-bordered">
                                    ...
                                    <tbody class="table-group-divider">
                                        @forelse ($ruangKelas as $index => $item)
                                            <tr>
                                                <td class="text-center">{{ $ruangKelas->firstItem() + $index }}</td>
                                                <td>{{ $item->nama }}</td>
    ...
    @include('livewire.superadmin.admin.ruang-kelas.create')
    @script
    <script>
    ...
    @endscript
    @include('livewire.superadmin.admin.ruang-kelas.edit')
    @script
    <script>
    ...
    @endscript
    @include('livewire.superadmin.admin.ruang-kelas.delete')
    @script
    <script>
