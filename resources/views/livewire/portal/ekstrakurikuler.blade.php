  ...
  <div class="container">
    ...
    <div class="row mb-5">
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Football">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Basketball">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Volleyball">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Swimming">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Badminton">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Martial Arts">
          <div class="card-body">
    ...
    <div class="row mb-5">
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Music">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Dance">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Drama">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Visual Arts">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Photography">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Debating">
          <div class="card-body">
    ...
    <div class="row">
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Robotics">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Science">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Math">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Environment">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Newspaper">
          <div class="card-body">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card">
          <img src="{{ asset('assets/akademik.webp') }}" class="card-img-top" alt="Entrepreneurship">
          <div class="card-body">
