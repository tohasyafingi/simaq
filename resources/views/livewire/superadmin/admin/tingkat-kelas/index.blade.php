<div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-sm table-bordered">
                                    ...
                                    <tbody class="table-group-divider">
                                        @forelse ($tingkatKelas as $index => $item)
                                            <tr>
                                                <td class="text-center">{{ $tingkatKelas->firstItem() + $index }}</td>
                                                <td>{{$item->tingkat}}</td>
                                                <td>{{ $item->urutan }}</td>
    ...
    @include('livewire.superadmin.admin.tingkat-kelas.create')
    @script
    <script>
    ...
    @endscript
    @include('livewire.superadmin.admin.tingkat-kelas.delete')
    @script
    <script>
