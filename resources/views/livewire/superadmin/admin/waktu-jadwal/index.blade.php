<div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-sm table-bordered">
                                    ...
                                    <tbody class="table-group-divider">
                                        @forelse($waktus as $index => $item)
                                            <tr>
                                                <td class="text-center">{{ $waktus->firstItem() + $index }}</td>
    ...
    @include('livewire.superadmin.admin.waktu-jadwal.create')
    @script
    <script>
    ...
    @endscript
    @include('livewire.superadmin.admin.waktu-jadwal.edit')
    @script
    <script>
    ...
    @endscript
    @include('livewire.superadmin.admin.waktu-jadwal.delete')
    @script
    <script>
