<div>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between mb-1">
                                ...
                                <div>
                                    ...
                                    <!-- Tombol Export Data Tata Usaha -->
                                    <button wire:click="export" class="btn btn-md btn-primary">
                                        <i class="fas fa-file-export"></i> Export
                                    </button>

                                    <x-modal-import id="importModal" title="Import Data Tata Usaha" inputName="file" />
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-sm table-bordered">
                                    ...
                                    <tbody class="table-group-divider">
                                        @forelse($tata_usahas as $index => $item)
                                            <tr>
                                                <td class="text-center">{{ $tata_usahas->firstItem() + $index }}</td>
                                                <td class="text-center">
                                                    @if($item->img)
                                                        <img src="{{ asset('storage/' . $item->img) }}" alt="Foto Karyawan"
    ...
    @include('livewire.superadmin.admin.tata-usaha.create')
    @script
    <script>
    ...
    @endscript
    @include('livewire.superadmin.admin.tata-usaha.edit')
    @script
    <script>
    ...
    @endscript
    @include('livewire.superadmin.admin.tata-usaha.delete')
    @script
    <script>
